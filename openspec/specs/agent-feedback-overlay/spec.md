...
## Purpose
Feedback visual do cursor do agente durante ações — pacing, entrada/saída de tela e sinalização de clique — renderizado como overlay sem roubar o ponteiro do usuário.
## Requirements
