...
## Purpose
`POST /v1/annotate_window` devolve um screenshot com marks numerados mapeados a coordenadas model-facing e uma tabela machine-readable de alvos, para o agente escolher elementos visualmente.
## Requirements
