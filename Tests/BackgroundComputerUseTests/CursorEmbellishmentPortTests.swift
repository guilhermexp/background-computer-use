...
struct CursorEmbellishmentPortTests {
    ...
    func lockedSwoopyMotionConstantsAndDurationFormula() {
        ...
        #expect(abs(CursorMotionConstants.speedMultiplier - 2.20) <= 0.0001)
    ...
    func lockedActionTimingDefaults() {
        ...
        #expect(timings.secondaryPreRippleMilliseconds == 50)
        #expect(timings.secondaryDwellMilliseconds == 220)
        #expect(timings.scrollStreakMilliseconds == 260)
        #expect(timings.scrollDwellMilliseconds == 260)
        #expect(timings.pressKeyPreBounceMilliseconds == 35)
        #expect(timings.pressKeyHoldMilliseconds == 55)
        #expect(timings.pressKeyReleaseMilliseconds == 150)
        #expect(timings.setValuePreRippleMilliseconds == 45)
        #expect(timings.setValueDwellMilliseconds == 200)
        #expect(timings.typeArrowToIBeamMilliseconds == 60)
        #expect(timings.typeIBeamToCaretMilliseconds == 60)
        #expect(timings.typeCharacterIntervalMilliseconds == 28)
        #expect(timings.typeTailDwellMilliseconds == 160)
        #expect(timings.morphDurationMilliseconds == 150)
    }
